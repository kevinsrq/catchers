...
pub fn linear_trend(x: &[f64]) -> (f64, f64, f64, f64, f64) { // slope, intercept, r_value, p_value, stderr
    let n = x.len() as f64;
    if n < 2.0 {
    ...
    let cov: f64 = idx.iter().zip(x.iter())
